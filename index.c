...
void main()
{
    ...
    struct teams team[5] = {{1, "Patna_Pirates"}, {2, "Dabang_Delhi"}, {3, "Bengaluru_Bulls"}, {4, "Mumbai_Indians"}, {5, "Telugu_Titans"}};

    struct points point[5] = {{1, "Patna_Pirates", 22, 20, 1, 1, 103}, {2, "Dabang_Delhi", 22, 19, 2, 1, 98}, {3, "Bengaluru_Bulls", 22, 18, 4, 0, 90}, {4, "Mumbai_Indians", 22, 17, 4, 1, 88}, {5, "Telugu_Titans", 22, 16, 4, 2, 86}};
...
{
    int n;
    printf("\n\tEnter the serial number of the player: "); //input of serial number to update the desired record
    scanf("%d", &n);
    printf("\tEnter name of the player: ");
